  ...
  while (ss.available() > 0)
    if (gps.encode(ss.read())){
      if (gps.location.isValid()){
        ...
        Firebase.setFloat("6eUcgN0B1rc9jVX8axa00yAmajm2/longitude",longitude);
        if (Firebase.failed()) {
        ...
        Firebase.setFloat("6eUcgN0B1rc9jVX8axa00yAmajm2/latitude",latitude);
        if (Firebase.failed()) {
            Serial.print("value /value failed:");
            Serial.println(Firebase.error());  
            delay(1000);
      ...
      if (gps.date.isValid()){
        ...
        Firebase.setString("6eUcgN0B1rc9jVX8axa00yAmajm2/date",date_str);
        if (Firebase.failed()) {
            Serial.print("value /value failed:");
            Serial.println(Firebase.error());  
            delay(1000);
      ...
      if (gps.time.isValid()){
        ...
        Firebase.setString("6eUcgN0B1rc9jVX8axa00yAmajm2/time",time_str);
        if (Firebase.failed()) {
            Serial.print("value /value failed:");
            Serial.println(Firebase.error());  
            delay(1000);
      ...
      if (gps.speed.isValid()) {
        ...
        Firebase.setFloat("6eUcgN0B1rc9jVX8axa00yAmajm2/speed",speed_kmph);
        if (Firebase.failed()) {
            Serial.print("value /value failed:");
            Serial.println(Firebase.error());  
            delay(1000);
